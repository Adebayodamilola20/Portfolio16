    ...
    <ScrollFadeIn className="min-h-screen bg-[#0E0E13] text-white">
      <section className="pt-40 pb-24 px-6 text-center">
        <ScrollFadeIn className="max-w-4xl mx-auto">
          <span className="text-gray-500 font-mono text-[10px] tracking-[0.4em] uppercase mb-8 block">Service 05 / Integrations</span>
          <h1 className="text-6xl md:text-8xl font-bold tracking-tight mb-8">Systems <br /><span className="text-gray-500 italic">Integrations</span></h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-20 font-medium">Connect your existing tools and data to create a unified, efficient business ecosystem.</p>
        </ScrollFadeIn>
      </section>
