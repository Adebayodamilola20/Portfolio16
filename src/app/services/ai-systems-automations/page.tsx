  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white selection:bg-blue-500/30">
      ...
      <section className="relative pt-40 pb-32 px-6 overflow-hidden">
        ...
        <div className="max-w-[70rem] mx-auto relative z-10 flex flex-col items-center text-center">
          <motion.span 
            ...
            className="text-[#60A5FA] font-mono text-[10px] tracking-[0.2em] uppercase mb-12 block font-semibold"
          >
            Service 01 / AI & Automations
          </motion.span>
          <motion.h1 
            initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }}
            className="text-6xl md:text-[5.5rem] font-normal tracking-tight mb-10 leading-[1.1] text-white"
          >
            AI Systems & <br /> <span className="text-[#60A5FA]">Automations</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
            className="text-[#9CA3AF] text-[1.1rem] max-w-2xl mx-auto leading-relaxed mb-32"
          >
            Work smarter. Scale faster. Eliminate inefficiencies with intelligent automation.
          </motion.p>
          ...
          >
            <p className="text-[1.25rem] leading-[1.8] text-gray-300 pb-20">
              Every business has hidden inefficiencies - repetitive tasks, manual processes, and data bottlenecks that waste time and money. At Stephen Software Studio, we design <strong className="text-white font-medium">AI-powered systems and intelligent automations</strong> that eliminate wasted effort, streamline operations, and unlock new levels of productivity.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative py-24 px-6 bg-[#FAF9F6] border-y border-white/5 overflow-hidden">
        ...
        >
          <div className="pt-2">
            <span className="text-[#60A5FA] font-mono text-[10px] tracking-[0.2em] uppercase leading-relaxed mb-8 block font-semibold">Why It Matters</span>
            <h2 className="text-4xl md:text-[3.25rem] font-normal tracking-tight mb-6 leading-[1.1] text-black">
              Automation is no longer<br />optional
            </h2>
            <p className="text-base text-gray-600 max-w-md leading-[1.6]">
              The companies that win are the ones that leverage AI to move faster, scale leaner, and operate smarter.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              "Reduce operating costs without reducing output", 
              "Reclaim hundreds of hours by automating manual work",
              "Make smarter decisions with AI-driven insights",
              "Scale without needing to scale headcount"
            ].map((text, i) => (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-24 gap-y-16">
            <div className="flex flex-col gap-16">
              <div>
                <h3 className="text-[1.35rem] font-semibold text-white mb-3">Custom AI Workflows</h3>
                <p className="text-[#9CA3AF] text-[15px] leading-relaxed">
                  Intelligent systems that replicate human decision-making and adapt to your business logic.
                </p>
              </div>
              <div className="border-l-[2px] border-[#1e3a8a] pl-6 py-1 -ml-6">
                <h3 className="text-[1.35rem] font-semibold text-white mb-3">Business Process Automation</h3>
                <p className="text-[#9CA3AF] text-[15px] leading-relaxed">
                  Eliminate friction across your operations with smart workflow automation.
                </p>
              </div>
              <div>
                <h3 className="text-[1.35rem] font-semibold text-white mb-3">Platform & API Automations</h3>
                <p className="text-[#9CA3AF] text-[15px] leading-relaxed">
                  Connect all your tools into one seamless, intelligent ecosystem.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-16">
              <div>
                <h3 className="text-[1.35rem] font-semibold text-white mb-3">Data Processing at Scale</h3>
                <p className="text-[#9CA3AF] text-[15px] leading-relaxed">
                  Intelligent data processing and analysis that handles millions of records effortlessly.
                </p>
              </div>
              <div className="bg-[#0c1222] p-8 -mx-8 rounded-2xl">
                <h3 className="text-[1.35rem] font-semibold text-[#60A5FA] mb-3">Machine Learning Integrations</h3>
                <p className="text-[#9CA3AF] text-[15px] leading-relaxed">
                  Systems that learn from data and improve their performance over time.
                </p>
              </div>
              <div>
                <h3 className="text-[1.35rem] font-semibold text-white mb-3">Predictive Analytics</h3>
                <p className="text-[#9CA3AF] text-[15px] leading-relaxed">
                  AI-powered insights that help you make smarter, data-driven decisions.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-32 px-6 bg-[#FAF9F6] border-y border-gray-200/50 overflow-hidden">
        ...
        >
          <div className="sticky top-32">
            <span className="text-[#60A5FA] font-mono text-[10px] tracking-[0.2em] uppercase leading-relaxed mb-8 block font-semibold">Our Process</span>
            <h2 className="text-4xl md:text-[3.25rem] font-normal tracking-tight mb-6 leading-[1.1] text-black">
              From discovery to<br />deployment
            </h2>
            <p className="text-base text-gray-600 max-w-sm leading-[1.6]">
              A proven methodology that delivers reliable, scalable AI systems.
            </p>
          </div>

          <div className="flex flex-col relative pb-10">
            {[
              { num: "01", title: "Discovery", desc: "We map out your workflows, identify bottlenecks, and highlight automation opportunities that will deliver the highest ROI.", active: false },
              { num: "02", title: "Design", desc: "We architect a solution tailored to your business goals, ensuring scalability and long-term growth.", active: true },
              { num: "03", title: "Development", desc: "We build and integrate AI systems using proven frameworks, modern platforms, and best practices.", active: false },
              { num: "04", title: "Testing", desc: "We stress-test automation across edge cases to ensure reliability, accuracy, and performance under real-world conditions.", active: false },
              { num: "05", title: "Deployment & Support", desc: "We launch, monitor performance, and continuously refine the system as your business scales and evolves.", active: false }
            ].map((step, i) => (
              <div key={i} className={`relative flex gap-8 p-8 transition-all duration-300 ${step.active ? 'bg-white/80 shadow-[0_4px_30px_rgba(0,0,0,0.03)] rounded-2xl border border-gray-200/50' : 'hover:bg-white/50 hover:shadow-[0_4px_20px_rgba(0,0,0,0.02)] rounded-2xl border border-transparent'} -mx-8 group`}>
                ...
                <span className="text-4xl md:text-5xl font-bold text-[#60A5FA]/30 mt-1 shrink-0">{step.num}</span>
      ...
      <section className="relative py-32 px-6 bg-[#0A0A0A]">
        ...
        >
          <span className="text-[#60A5FA] font-mono text-[10px] tracking-[0.2em] uppercase leading-relaxed mb-6 block font-semibold text-center">Technology Stack</span>
            ...
            {[
              {
                ...
                desc: "Python • TensorFlow • PyTorch • OpenAI APIs • Hugging Face",
                align: "left"
              },
              {
                num: "02",
                ...
                desc: "Zapier • Make • n8n • Custom workflow engines",
                align: "right"
              },
              {
                num: "03",
                ...
                desc: "PostgreSQL • MongoDB • Redis • Cloud data pipelines",
                align: "left"
              },
              {
                num: "04",
                ...
                desc: "AWS • Google Cloud • Docker • Kubernetes • Serverless",
                align: "right"
              }
            ].map((node, i) => (
