...
export default function ProjectDetailPage() {
  return (
    <ScrollFadeIn className="min-h-screen bg-[#0E0E13] text-white pt-40 pb-32">
       <ScrollFadeIn className="max-w-7xl mx-auto px-6 text-center mb-20">
       ...
       <ScrollFadeIn className="max-w-4xl mx-auto px-6">
